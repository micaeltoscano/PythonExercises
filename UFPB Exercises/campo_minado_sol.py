...
# Calcula o numero de bombas ao redor das celulas que nao sao bombas
for i in range(0, num_linhas):
   for j in range(0, num_linhas):
      ...
      if (conteudo_celula[i][j] != "X"):
         ...
         # Direita   
         if (j + 1 < num_linhas and conteudo_celula[i][j + 1] == "X"):
            nb_bombas_ao_redor += 1

         # Abaixo   
         if (i + 1 < num_linhas and conteudo_celula[i + 1][j] == "X"):
            nb_bombas_ao_redor += 1
      ...
      if (evento.type == pygame.MOUSEBUTTONDOWN and evento.button == 1):
          ...
          if (not celula_revelada[celula_x][celula_y]):
             ...
             if (conteudo_celula[celula_x][celula_y] == "X"):
                ...
                perdeu = True                             
             elif (num_celulas_abertas + num_bombas == num_linhas**2): #verifica se ganhou
